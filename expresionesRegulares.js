...
function esValidaURL(url){
	...
	if ((url[0].endsWith(".com") || url[0].endsWith(".es")) && (url[0].startsWith("http://www.") ||
	 url[0].startsWith("https://www.")) && url[1].split("&", url[1].length).length >=2)  {
